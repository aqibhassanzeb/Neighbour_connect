  ...
  //  setSelectedId(item.key);
      ...
      style={{
        ...
        flexDirection:"row"
             ...
             {showFirstIcon ? (
          <Ionicons name="person-add-outline" size={24} color="white" paddingRight={7}/>
        ) : (
          <Ionicons name="checkmark-circle" size={24} color="white" paddingRight={7}/>
        )}
      
        <Text style={{ ...Fonts.SemiBold18white }}>
          {isClicked ? 'Connected' : 'accept'}
        </Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
