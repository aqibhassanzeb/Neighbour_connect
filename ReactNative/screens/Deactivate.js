  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.extraLightGrey }}>
      ...
      <View style={styles.container}>
        ...
        >
          We're sorry you are leaving
        </Text>
        <Text style={{ color: Colors.black, fontSize: 17, marginBottom: 32 }}>
          Please note that by proceeding with account deletion, all your data,
          including profile information, posts, replies, and messages, will be
          permanently removed from our system. This action is irreversible. If
          you have any concerns or questions, please contact our support team
          for assistance. To confirm the account deletion, select a reason below
        </Text>
        ...
        {dropdownOpens && (
          <View style={styles.dropdowns}>
            <TouchableOpacity
              onPress={() => handleOptionSelects("Didn't find it useful ")}
            >
              <Text style={{ padding: 10 }}>Didn't find it useful </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => handleOptionSelects("Duplicate account ")}
            >
              <Text style={{ padding: 10 }}>Duplicate account </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => handleOptionSelects("Not enough neighbors ")}
            >
              <Text style={{ padding: 10 }}>Not enough neighbors</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => handleOptionSelects("Other reasons ")}
            >
